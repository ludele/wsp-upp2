...
exports.handleDiscussionRoute = async function (request, response) {
  ...
  let template = await fs.readFile('./templates/posts.maru', 'utf-8');

  let postsHTML = posts.map(generatePostHTML).join('');
